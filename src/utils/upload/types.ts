...
export interface DetectedFormat {
  type: 'piccoma_sokuhochi' | 'piccoma_kpi' | 'cmoa_sokuhochi' | 'cmoa_excel' | 'weekly_report' | 'ruikei_metadata' | 'renta_sokuhochi' | 'ebookjapan_sokuhochi' | 'linemanga_sokuhochi' | 'unknown';
  platform: string;
